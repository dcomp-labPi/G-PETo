...
int main(int argc, char **argv){
	...
	void *ptrLib;
	ptrLib = dlopen("/home/labpi/Dropbox/Experimentos_artigo_2/libfw.so",RTLD_LAZY);
	FILE *functions_names_file, *rank_map_file, *ranks_per_device;

	functions_names_file = fopen("/home/labpi/Dropbox/Experimentos_artigo_2/functions_names","r");
	rank_map_file = fopen("/home/labpi/Dropbox/Experimentos_artigo_2/comm/rank_map","w");
	ranks_per_device = fopen("/home/labpi/Dropbox/Experimentos_artigo_2/comm/config","r");
