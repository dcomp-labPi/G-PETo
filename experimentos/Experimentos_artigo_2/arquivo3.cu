...
const char *sSDKname3     = "conjugateGradient";

/* genTridiag: generate a random tridiagonal symmetric matrix */
void genTridiag_3(int *I, int *J, float *val, int N, int nz)
{
    I[0] = 0, J[0] = 0, J[1] = 1;
...
extern "C" void funcao3(){
	...
	for(iter=0;iter<20;iter++){
		receiveMessage("funcao3","funcao2", FLOAT, (void*)d_x, N*N);
		receiveMessage("funcao3","funcao2", INT, (void*)d_col, nz);
		receiveMessage("funcao3","funcao2", INT, (void*)d_row, N+1);
		receiveMessage("funcao3","funcao2", FLOAT, (void*)d_val, nz);
